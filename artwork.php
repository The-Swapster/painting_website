...
<body>
    ...
    <div id="container">
        <h1 style="color: black">Artwork</h1>
        <!-- Slideshow container -->
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                ...
                <a href="oil.php"><img src="Images/Oil/1.jpg" style="width:100%"></a>
                <div class="text">Oil Painting</div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">2 / 3</div>
                <a href="acrylic.php"><img src="Images/Acrylic/a1.jpg" style="width:100%"></a>
                <div class="text">Acrylic Painting</div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">3 / 3</div>
                <a href="watercolour.php"><img src="Images/Watercolor/w1.jpg" style="width:100%"></a>
                <div class="text">Water Colour Painting</div>
            </div>
