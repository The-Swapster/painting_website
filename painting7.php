...
<head>
    <title>Girl Picking Flowers</title>
...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Girl picking flowers</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p7.jpg">
                <img src="Images/painting/p7.jpg">
            </a>
            <div class="desc">Paint ID: P007</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
