...
<head>
    <title>Abstract Lightening</title>
...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Abstract Lightning</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p22.jpg">
                <img src="Images/painting/p22.jpg">
            </a>
            <div class="desc">Paint ID: P022</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
