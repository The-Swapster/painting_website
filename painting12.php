...
<head>
    <title>Entryway with flowers 1</title>
...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Entryway with Flowers 1</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p12.jpg">
                <img src="Images/painting/p12.jpg">
            </a>
            <div class="desc">Paint ID: P012</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
