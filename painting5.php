...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Flower Fusion</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p5.jpg">
                <img src="Images/painting/p5.jpg">
            </a>
            <div class="desc">Paint ID: P005</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
