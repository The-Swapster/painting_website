...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Blue</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p18.jpg">
                <img src="Images/painting/p18.jpg">
            </a>
            <div class="desc">Paint ID: P018</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
            <p>₹ <?php echo $row['bid'] ?><?php
