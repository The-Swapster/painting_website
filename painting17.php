...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Abstract Flow</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p17.jpg">
                <img src="Images/painting/p17.jpg">
            </a>
            <div class="desc">Paint ID: P017</div>
        </div>w
        <div id='bid'>
            <p>Current Bid: </p>
