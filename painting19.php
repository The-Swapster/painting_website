...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Abstract Fusion</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p19.jpg">
                <img src="Images/painting/p19.jpg">
            </a>
            <div class="desc">Paint ID: P019</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
