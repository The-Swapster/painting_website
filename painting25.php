...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Fusion Flowers</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p25.jpg">
                <img src="Images/painting/p25.jpg">
            </a>
            <div class="desc">Paint ID: P025</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
