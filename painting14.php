...
<head>
    <title>Entryway with flowers 3</title>
...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Entryway with Flowers 3</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p14.jpg">
                <img src="Images/painting/p14.jpg">
            </a>
            <div class="desc">Paint ID: P014</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
