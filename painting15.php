...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Confetti</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p15.jpg">
                <img src="Images/painting/p15.jpg">
            </a>
            <div class="desc">Paint ID: P015</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
