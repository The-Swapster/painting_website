...
<head>
    <title>Flower Oil Painting</title>
...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Flowers oil painting</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p10.jpg">
                <img src="Images/painting/p10.jpg">
            </a>
            <div class="desc">Paint ID: P010</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
