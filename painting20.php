...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Abstract Enigma</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p20.jpg">
                <img src="Images/painting/p20.jpg">
            </a>
            <div class="desc">Paint ID: P020</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
