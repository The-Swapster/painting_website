...
<head>
    <title>Entryway with flowers 2</title>
...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Entryway with Flowers 2</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p13.jpg">
                <img src="Images/painting/p13.jpg">
            </a>
            <div class="desc">Paint ID: P013</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
