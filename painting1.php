...
<body>
    ...
    <div id="container">
        ...
        ?>
        <h1 style="color: black">Abstract Rust</h1>
        <div class="gallery">
            <a target="_blank" href="Images/painting/p1.jpg">
                <img src="Images/painting/p1.jpg">
            </a>
            <div class="desc">Paint ID: P001</div>
        </div>
        <div id='bid'>
            <p>Current Bid: </p>
